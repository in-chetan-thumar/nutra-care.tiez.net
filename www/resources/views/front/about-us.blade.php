    ...
    <div class="row">
      ...
      <div class="col-md-12 col-lg-9">
        <div class="value_right">
          <div class="value_box">
            <h4>A Chemical Approach <br/> to Health</h4>
          ...
          <div class="value_box">
            <h4>Keeping Up with Your Needs <br/> & Demands</h4>
          ...
          <div class="value_box">
            <h4>Excelling but with Integrity <br/> and Honesty</h4>
          ...
          <div class="value_box">
            <h4>Flexibility and Quality as <br/> the Crux</h4>
