            ...
            <div class="catalogue_main">
                <div class="row" style="--bs-gutter-x:0 !important;display: inline-flex; min-width: 100%;">
                    <div class="sidenav col-lg-3 ">
                        <div class="col-md-12">
                            <h4>PRODUCT CATEGORIES <span style=" float: right; font-size: 15px;cursor: pointer;color: #000"
                                    class="clearFilter"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                        width="20" height="20" viewBox="0 0 50 50" style="fill:#40C057;">
                                        <path
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <button type="submit" name="submit" id="show-only-selected" value="upload" class="btn product-button"
                        onclick="onlySelectShow()">Show only selected
                    </button>
                </div>
            </div>
        </div>
